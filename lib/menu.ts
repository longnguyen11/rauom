  ...
  return [
    {
      ...
      copy: {
        vi: {
          name: "Phở Bò",
          description: "Phở bò với nước dùng thơm đậm đà, mở bán theo mẻ trong tuần.",
          price: "$15/tô",
          imageAlt: "Phở bò",
        },
        en: {
          name: "Pho Bo (Beef Pho)",
          description: "Beef pho with a rich, aromatic broth, available in this weekly batch.",
          price: "$15/bowl",
          imageAlt: "Pho Bo beef pho",
        },
      },
    },
    {
      ...
      copy: {
        vi: {
          name: "Chưa có món",
          description: "Hiện chưa có món tạm thời thứ hai.",
          price: "",
          imageAlt: "Chưa có món",
        },
        en: {
          name: "Not available",
          description: "There is no second temporary dish right now.",
          price: "",
          imageAlt: "No dish available",
        },
      },
    },
  ];
