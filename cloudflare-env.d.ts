/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 71b4e4f0a7d7a1933409f7a4344a96ea)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "ORIGIN_ADDRESS" | "ORIGIN_LAT" | "ORIGIN_LNG" | "TIMEZONE" | "MIN_LEAD_TIME_DAYS_DEFAULT" | "MANUAL_PAYMENT_BUFFER_HOURS" | "MAX_DELIVERY_DISTANCE_MI" | "ADMIN_ACCESS_TOKEN" | "TURNSTILE_SECRET_KEY" | "MAPBOX_ACCESS_TOKEN" | "RESEND_API_KEY" | "RESEND_FROM_EMAIL" | "RESEND_OWNER_EMAIL">> {}
}
